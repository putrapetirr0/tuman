...
# Install packages untuk Ubuntu 22+
apt install -y bzip2 gzip coreutils wget screen rsyslog iftop htop \
    net-tools zip unzip curl nano sed screen gnupg gnupg2 bc \
    apt-transport-https build-essential dirmngr libxml-parser-perl \
    neofetch git lsof chrony python3 python3-pip jq
