...
# Untuk Ubuntu 22.04+, beberapa package berbeda
if [[ $(lsb_release -rs) == "22.04" ]] || [[ $(lsb_release -rs) == "24.04" ]]; then
    apt-get install -y bzip2 gzip coreutils wget screen rsyslog iftop htop net-tools zip unzip net-tools curl nano sed screen gnupg gnupg2 bc apt-transport-https build-essential dirmngr libxml-parser-perl neofetch git lsof
else
    apt-get install -y bzip2 gzip coreutils wget screen rsyslog iftop htop net-tools zip unzip wget net-tools curl nano sed screen gnupg gnupg1 bc apt-transport-https build-essential dirmngr libxml-parser-perl neofetch git lsof
fi
