...
echo -e "[ ${green}INFO${NC} ] Detected Ubuntu Version: $UBUNTU_VERSION"

if [ "$UBUNTU_VERSION" != "20.04" ] && [ "$UBUNTU_VERSION" != "22.04" ] && [ "$UBUNTU_VERSION" != "24.04" ]; then
    echo -e "[ ${yellow}INFO${NC} ] This script is optimized for Ubuntu 20.04/22.04/24.04"
fi
...
echo "Checking VPS - Ubuntu $UBUNTU_VERSION"
...
echo -e "[ ${green}INFO${NC} ] Preparing the autoscript installation for Ubuntu $UBUNTU_VERSION"
apt install git curl -y >/dev/null 2>&1

# Update system for Ubuntu 22.04
echo -e "[ ${green}INFO${NC} ] Updating system packages..."
apt update -y
apt upgrade -y

# Install specific dependencies for Ubuntu 22.04
echo -e "[ ${green}INFO${NC} ] Installing Ubuntu $UBUNTU_VERSION dependencies..."
...
echo -e "${red}    ♦️${NC} ${green} UBUNTU $UBUNTU_VERSION - CLOUDFLARE SETUP     ${NC}"
...
sleep 1
wget -q -O /root/ssh-vpn-ubuntu22.sh "https://raw.githubusercontent.com/putrapetirr0/tuman/refs/heads/main/ssh-vpn-ubuntu22.sh"
chmod +x /root/ssh-vpn-ubuntu22.sh
./ssh-vpn-ubuntu22.sh
sleep 3
clear
...
sleep 3
wget -q -O /root/xray-ubuntu22.sh "https://raw.githubusercontent.com/putrapetirr0/tuman/refs/heads/main/xray-ubuntu22.sh"
chmod +x /root/xray-ubuntu22.sh
./xray-ubuntu22.sh
...
# Cleanup
rm -f /root/xray-ubuntu22.sh /root/set-br.sh /root/ssh-vpn-ubuntu22.sh
echo "2.0" > /home/ver
...
echo ""
echo -e "${RB}      .-------------------------------------------.${NC}"
echo -e "${RB}      |${NC}    ${CB}UBUNTU $UBUNTU_VERSION INSTALL COMPLETED${NC}    ${RB}|${NC}"
echo -e "${RB}      '-------------------------------------------'${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "      ${WB}Multiport Websocket + Ubuntu $UBUNTU_VERSION${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
echo -e "  ${GB}✓${NC} ${WB}Ubuntu Version:${NC} $UBUNTU_VERSION"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${WB}Available Management Commands:${NC}"
echo -e "  ${YB}add-ws${NC}    - Add VMESS user"
echo -e "  ${YB}add-vless${NC} - Add VLESS user"  
echo -e "  ${YB}add-tr${NC}    - Add Trojan user"
echo -e "  ${YB}menu${NC}      - Main menu"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo ""
secs_to_human "$(($(date +%s) - ${start}))"
echo ""
rm -f setup2-ubuntu22.sh
echo ""
