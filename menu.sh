...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}06.${NC} ${YB}INSTALL ADS BLOCK ${NC}       ${RB}17.${NC} ${YB}SPEEDTEST ${NC}"
echo -e "  ${RB}07.${NC} ${YB}INSTALL TCP BBRPLUS ${NC}     ${RB}18.${NC} ${YB}CHECK CPU & RAM ${NC}"
echo -e "  ${RB}08.${NC} ${YB}ADS BLOCK MENU ${NC}          ${RB}19.${NC} ${YB}CHECK BANDWIDTH ${NC}"
echo -e "  ${RB}09.${NC} ${YB}DNS CHANGER ${NC}             ${RB}20.${NC} ${YB}BACKUP ${NC}"
echo -e "  ${RB}10.${NC} ${YB}NETFLIX CHECKER ${NC}         ${RB}21.${NC} ${YB}AUTOBACKUP ${NC}"
echo -e "  ${RB}11.${NC} ${YB}LIMIT BANDWITH SPEED ${NC}    ${RB}22.${NC} ${YB}RESTORE ${NC}"
echo -e "  ${RB}12.${NC} ${YB}CHANGE DOMAIN ${NC}           ${RB}23.${NC} ${YB}REBOOT ${NC}"
echo -e "  ${RB}13.${NC} ${YB}RENEW CERT XRAYS ${NC}        ${RB}24.${NC} ${YB}XRAY-CORE MENU ${NC}"
echo -e "  ${RB}14.${NC} ${YB}CHECK VPN STATUS ${NC}        ${RB}25.${NC} ${YB}SWAPRAM MENU ${NC}"
echo -e "  ${RB}15.${NC} ${YB}CHECK VPN PORT ${NC}          ${RB}26.${NC} ${YB}CLEAR LOG ${NC}"
echo -e "  ${RB}16.${NC} ${YB}RESTART VPN SERVICE ${NC}     ${RB}27.${NC} ${YB}ADD BOT TELEGRAM ${NC}"
echo -e "  ${RB}00.${NC} ${YB}EXIT ${NC}"
echo -e "  "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
